            ...
            <div class="details">
                <div class="recentorders">
                    ...
                    <%
                        ...
                        {
                    %>
  <form action="/update"  method="post" "multipart/form-data" >
	...
	<input type="text"  name="prodbrand" value="<%=product.getBrand() %>" readonly><br><br>
	
    <label for="fname">Category</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
    <input type="text"  name="category" value="<%=product.getCatagory() %>" readonly><br><br>
