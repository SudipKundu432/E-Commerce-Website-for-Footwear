...
@PostMapping("/order")
public String setOrderDetails(String custId,String productId,@RequestParam("address")String address)
{
	User user=ud.findById(custId).get();
	Product prod=pd.findById(productId).get();
